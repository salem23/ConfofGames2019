...
%\\ ------------------------------------------------------------------------
	...
	\item {\bf   Comment 6: Minor language comments: :} 
				...
				\item {\bf Response:} *** TO CHECK **\\
			Yes, the reviewer is right but we can use 'on the other hand' to introduce the second of {\bf two } contrasting points, facts, or ways of looking at something without 'on the one hand'.\\
			\url{https://dictionary.cambridge.org/grammar/british-grammar/contrasts}	\\
%%%%%%%%  or this link  
%%https://www.englishgrammar.org/hand/#:~:text=On%20the%20other%20hand%20is%20not%20a%20conjunction.,commas%20to%20set%20it%20off.				
				\\
				\item 	"previsely"?
