...
- how good a bot or controller is by playing the game -> how good a bot or controller is, is by playing the game
- $\alpha$ parameter allows to control the search... -> The $\alpha$ parameter allows to control the search


 Presentation Style:

- Sorry for being a bit picky with this: CG-Track 1 includes a linebreak in Section 5. This can be prevented by using \mbox{CG-Track 1}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
