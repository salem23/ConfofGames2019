...
\begin{table}[h!tb]
  \centering
  {\scriptsize
    \caption{Rules for speed (top) and steering (bottom) controller output. Additionally, when
      ...
      if the M10 is equal to Track 7 in the steering controller.
      These rules have been used since \cite{salem_evo18}. \label{tab:output:speed}\label{tab:output:steer}}
...
The structure of the winner controller {\sf GFC-GPSVAE} is depicted in Figures \ref{fig:frontmfs}, \ref{fig:max5mfs} and \ref{fig:max10mfs}. % Some comments are needed.
