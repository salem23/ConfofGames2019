...
simulator \ref{sec:torcs}, the defined fuzzy controllers
\ref{sec:subcontrollers} and a explanation of the evolutionary
algorithm implemented and tested in this work in Section
\ref{sec:GA_optimization}, including the new selection method and
...
\hline
      Value Front & Value MAX5 & Value MAX10 & Target Speed \\ % what
