...
\textit{Grand Prix Selection} (GPS), which \textcolor{red}{will} be able to reduce
uncertainty by using something more realistic than solo race scores to
...
will simply be removed from the pool. 
