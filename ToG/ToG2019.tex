...
\usepackage{colortbl}
%\usepackage[backend=bibtex,style=IEEEtranS,natbib=true]{biblatex}
%\addbibresource{geneura.bib} %added
%\addbibresource{uncertainty.bib} %added
%\addbibresource{fitnessless.bib} %added
%\addbibresource{fuzzy_torcs.bib} %added
...
\textit{Grand Prix Selection} (GPS), which will be able to reduce
...
reasonable speed \cite{Autodriv2006}. Additionally, in a racing car the controller has to be designed so that the car wins as many races as possible.
...
%
\textcolor{red}{
As it could be noticed in Table \ref{tab:RSresults}, the controller {\sf GFC-GPSE} has won the Grand Prix championship obtaining 438 points from 500 in the tracks used in the training, it has also ranked first in the testing tracks  \textit{E-Track 5} and \textit{Wheel 2}. 
