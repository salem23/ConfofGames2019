...
\IEEEtitleabstractindextext{%
  \begin{abstract}
    ...
    controllers, being able to beat, both standard and previously evolved controllers, as well as a high-ranked driver of TORCS competitions.
\end{abstract}
...
% Antonio - As I said previously, This was our initial proposal, not previously published in a journal and I personally prefer give a self-content publication. Because it is a mess to go to another 3 papers before being able to read and understand this one. Of course we cite previous papers, but I feel this information is needed here.
...
\begin{itemize}
	...
	\item $GFC-VA$: A controller obtained by applying $BLX-\alpha$
          ...
          Equation \ref{eqalpha} and fitness $f_{AVS}$. % wasn't this
                                % also in cig2018? - JJ
\end{itemize}
...
The skewness and kurtosis are computed for 1 in 5 individuals in the
population chosen randomly, and measured fitness values after the
first, the 20th and the last generation for the three controllers (See
Figure \ref{fig:gfcsk},\ref{fig:gfcrsesk} and Figure
