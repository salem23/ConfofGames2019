...
ones authored by Zhu et al.
\cite{zhu2018driving,zhu2019vision} rather
...
\begin{figure}[ht]	
	\begin{center}
          \includegraphics[width=8cm, height=2.2cm]{fig/GFC__.jpg}
          \includegraphics[width=8cm, height=2.2cm]{fig/GFCRSE__.jpg}
          \includegraphics[width=8cm, height=2.2cm]{fig/GFCVARSE__.jpg}
