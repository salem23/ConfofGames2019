...
The mechanism arranges groups of 10 individuals/controllers which are placed in a track in TORCS, where different races of several laps are simulated. Thus, they compete, using the same car (i.e. in the same conditions). After every race, the controllers get a scores according to their position in the final rank. This is a score function based in Formula 1 Grand Prix ranking, so the obtained punctuations per rank are: rank 1 - 25 points, 2 - 18, 3 - 15, 4 - 12, 5 - 10, 6 - 8, 7 - 6, 8 - 4, 9 - 2, 10 - 1.
