...
There are so many variables in this problem, that eventually the values of some of them are decided using heuristic rules, while the rest are open to
...
\textcolor{red}{
This is why performing an appropriate optimization process in this environment is a problem itself. 
}
