...
reasonable speed \cite{Autodriv2006}. Additionally, in a racing car the controller has to be designed so that the car wins in many races as possible.
...
\begin{table}[ht]
	\centering
	{\scriptsize
          \caption{\textcolor{red}{ Results of adaptive $BLX-\alpha$ controllers in a mini-championship with with 10 controllers
...
every generation has reached the best score, but please check out the
big impact of the application of the adaptive $BLX-\alpha$ operator in
all the controllers. Looking at the results in this table % please add
                                % reference - JJ
