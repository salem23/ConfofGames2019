...
% We need to clarify how long every simulation takes, even if it's
% only a ballpark. How much times does making the race every
% generation add to the total time? - JJ
