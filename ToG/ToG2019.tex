...
%
\title{Overtaking Uncertainty with Evolutionary Drivers for TORCS: Combining BLX-$\alpha$ Operator and Race-based Selection}
...
% I am going to comment out the whole section so that it's clear that
% we have to rewrite it from scratch - JJ
...
exploration and exploitation, and a \textit{Pole Position Selection policy of
...
% I find "race-based selection" a very bad name. REALLY bad. Either we
% don't mention it, or do it some other way  - JJ
% Antonio - I think it is much more accurate than Pole-Position selection, which is not what we do. Anyway, I'm very bad baptising things. If you can find a better name, please, let us know and we could update the name of the selection mechanism. ;)
...
% Antonio - Yes, we have done the same here, but extending the experiments with other configurations for the Race-based selection. ;)
	...
	{\scriptsize
                    ...
                    best.}
		{
			\begin{tabular}{|c|c|c||c|}
				...
				\hline
				\hline	
				$GFC-VARS5$&	82&	82&	{\em 164}\\
				$GFC-VARSE$&	108&    101&	{\bf 209}\\
				$GFC-VARSL$&	77&	73&	150\\
				$GFC$&	56&	50&	106\\
				$GFC-VA$&	46&	7&	53\\
				$inferno1$&	9&	8&	17\\
	...
	{\scriptsize
                    ...
                    best.}
		{
			\begin{tabular}{|c|c|c||c|}
				...
				\hline
				\hline
$GFC-RSE$&	85&	82&	{\em 167}\\
$GFC-VARSE$&111&101&            {\bf 212}\\
$GFC$&		48&	55&	103\\
$PSRI$&		53&	48&	101\\
$GFC-VA$&	78&	64&	142\\
$inferno1$&	9&	8&	17\\
...
The table \ref{tab:time} shows the average number of laps % Isn't this
                                % average running time? - JJ
and the
range of the generation where the best individual is found of all the
considered controllers. These results are obtained by running genetic
