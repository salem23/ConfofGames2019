...
\begin{figure}[!ht]	
	\begin{center}
		...
		\caption{Individual score skewness ($y$) and kurtosis ($x$) for
                  the fitless-ness method {\sf GFC-GPSE}.}
		\label{fig:gfcrsesk}	
	\end{center}	
\end{figure}
\begin{figure}[!ht]	
	\begin{center}
		...
		\caption{Skewness ($y$) and kurtosis ($x$) for a
                  ...
                  {\sf GFC-VAGPSE}, which is fitless-ness and also uses
...
we can affirm that fitness-less methods tend to evolve individuals
...
best between $GFC-GPSL$, $GFC-GPSE$ and $GFC-GPS5$, and between
