...
them with 180 degrees, which makes
...
``technical and complex'' \cite{AG}, for instance in
\cite{cardamone2010applying,CarRacing_Pelta09}; in \cite{AG} it had
the third lowest lap time, after Alpine 1 and Olethros, implying it
has got a good balance between hardness and speed.
