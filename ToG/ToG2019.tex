...
% Mohammed: yes there are negative values ( these values are th sinus of the steering angle)
%%when  M10=Track[7](nagative), we will take negative values of the steer (sterr=-steer)
    \begin{tabular}{|c|c|c||c|}
\hline
...
The second operator implemented in our GA is the adaptive \textbf{BLX-$\alpha$ Crossover} \cite{blx2008}, which allows to control the balance between exploration and exploitation along the generations.
