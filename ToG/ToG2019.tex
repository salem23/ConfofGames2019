...
\IEEEtitleabstractindextext{%
  \begin{abstract}
    ...
    our previous work, in this paper we evaluate a kind of fitlessness
    selection based on competition and called Grand Prix Selection (GPS), which should be able to reduce
    uncertainty by using something more realistic than solo race
    scores to select individuals; however, uncertainty has the
    ...
    controllers, being able to beat previously evolved controllers, as
    well as winners of TORCS competitions.
\end{abstract}
...
In a simulated and
    ...
    statistical varibable whose value will vary depending on track and
