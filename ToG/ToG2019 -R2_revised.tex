...
challenges: an evaluation function that \textcolor{green}{can} to separate the best
controllers from the rest, and a series of operators that \textcolor{green}{can} 
explore different possibilities in the controller search space. Within
the context of the TORCS racing simulator, in this paper\textcolor{green}{,} we introduce
...
reasonable speed \cite{Autodriv2006}.} Additionally, in a racing car\textcolor{green}{,} the controller has to be designed so that the car wins in as many races as possible.
...
This will mean a higher diversification factor in the first \textcolor{green}{generations} because the offspring will take much more different values for their genes in comparison with their parent and other descendants. %, i.e. the intervals in Figure \ref{fig:blxalpha} will be wider. 
