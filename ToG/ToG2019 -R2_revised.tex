...
challenges: an evaluation function that \textcolor{blue}{can} to separate the best
...
Fuzzy controllers are mentioned in around 15\% of the \textcolor{blue}{above-mentioned} articles, while around 30\% \textcolor{blue}{mentions} evolutionary algorithms; very few, however, around 7\%, use both, and most of them are not actually using TORCS (but just mentioning it); so the approach in this line of research is truly original in this context.
...
recombination \textcolor{blue}{,and} mutation, \textcolor{blue}{to} create a new population of
...
This will mean a higher diversification factor in the first \textcolor{blue}{generations} because the offspring will take much more different values for their genes in comparison with their parent and other descendants. %, i.e. the intervals in Figure \ref{fig:blxalpha} will be wider. 
...
in different ways.  \textcolor{red}{This is why we have computed
  ...
  values after the first, the 30th  \textcolor{blue}{,and} the last generation for the
