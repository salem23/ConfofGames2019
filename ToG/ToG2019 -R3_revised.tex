...
Email: amorag@ugr.es
\IEEEcompsocthanksitem J~J.~Merelo was with the Department of Computer Architecture and Technology. University of Granada, Spain.\protect\\
...
context of the TORCS racing simulator, in this paper \textcolor{red}{we introduce a
...
Grand Prix Selection, Uncertainty, \textcolor{red}{Competitive fitness}
\end{IEEEkeywords}}
...
problem winner (good runner {\em that wins races against other
  potentially good runners}).
	\textcolor{red}{Hereafter, we will use in general the
...
% Antonio - References of Jaskowski are almost the same (they describe the same work, but in different publications).
...
\cite{7792145}.\textcolor{red}{ The first one mentions ``imperfect information'',
...
possibilities. \textcolor{red}{This is an unique feature, not found in
...
\begin{table}[!htp]
	...
	{\scriptsize
		\caption{{\scriptsize Description of the controllers tested in the experiments.}}
		{
			\begin{tabular}{|c|c|c||c|}
				\hline
				GFC Controller&Fitness & GPS frequency&Xover operator \\
				\hline
				\hline
{\sf{GPSE}}&	\textcolor{red}{Competition-based}&Every gen.&Standard\\
{\sf{GPSVAE}}&	\textcolor{red}{Competition-based}&Every gen. & Varying BLX$-\alpha$\\

{\sf{GPS5}}\cite{DBLP:conf/cig/SalemMG19}&Hybrid&Every 5 gens.&Standard\\
{\sf{GPSVA5}}\cite{DBLP:conf/cig/SalemMG19}&Hybrid&Every 5 gens. & Varying BLX$-\alpha$\\

{\sf{GPSL}}\cite{DBLP:conf/cig/SalemMG19}&Hybrid &Last gen. &Standard\\

{\sf{GPSVAL}}\cite{DBLP:conf/cig/SalemMG19}&Hybrid &Last gen. & Varying BLX$-\alpha$\\
{\sf{Plain}}\cite{salem_cig2018}& Fitness $f_{AVS}$ (Eq \ref{fit_avg})&-&Standard xover\\
{\sf{VA}}\cite{DBLP:conf/cig/SalemMG19}&Fitness $f_{AVS}$ (Eq \ref{fit_avg})& - & Varying BLX$-\alpha$\\
...
\begin{figure}[ht]	
	\begin{center}
		\includegraphics[width=8cm, height=9cm]{fig/skew1.jpg}
...
Gaussian. 	\textcolor{red}{However, there are differences between the fitness-based
...
slowly towards values away from the center. 	\textcolor{red}{For the time being, we can
...
\begin{figure}[h]	
  \begin{center}
    \includegraphics[width=6.5cm, height=2.5 cm]{fig/FRONT.jpg}
    \includegraphics[width=6.5cm, height=2.5 cm]{fig/MAX5.jpg}
    \includegraphics[width=6.5cm, height=2.5 cm]{fig/MAX10.jpg}		
...
results.
	\textcolor{red}{In races performed in the training, and other, tracks, the controller
