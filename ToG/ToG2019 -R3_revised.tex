	...
	{\scriptsize
		\caption{ Description of the controllers tested in the experiments.}
		{
			\begin{tabular}{|c|c|c||c|}
				...
				\hline
				\hline
{\sf{GFC-GPSE}}&	\textcolor{red}{Competition-based}&Every generation&Standard crossover\\
{\sf{GFC-GPSVAE}}&	\textcolor{red}{Competition-based}&Every generation & Varying BLX$-\alpha$\\
